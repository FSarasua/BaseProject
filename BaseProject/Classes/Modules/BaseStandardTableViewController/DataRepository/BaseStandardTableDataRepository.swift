...
open class BaseStandardTableDataRepository {
    
    static let shared = BaseStandardTableDataRepository()
    
    func getBaseStandardTableViewModel() -> BaseStandardTableViewModel {
        var model = BaseStandardTableViewModel()
        
        model.tableViewData = getExamplesCell()
